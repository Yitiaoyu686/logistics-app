...
export const warehouseApi = {
  ...
  updateUnmatched: (id: string, data: any) => api.put(`/warehouse/no-order-express/${id}`, data),
  deleteUnmatched: (id: string) => api.delete(`/warehouse/no-order-express/${id}`),
  returnUnmatched: (id: string, data: any) => api.post(`/warehouse/no-order-express/${id}/return`, data),
  ...
  cancelInbound: (data: { orderId: string; reason: string; goodsReceived: boolean }) => api.post('/v2/wms/inbounds/cancel', data),
  deleteInbound: (id: string) => api.delete(`/v2/wms/inbounds/${id}`),
